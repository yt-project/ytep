...
long-term development effort is the (at the time of writing) ongoig work to
...
named branch. If a compelling reason arises to add a new bookmark, the project
members must agree to create it.

If no ongoing work is happening on a long-term feature, the ``experimental``
bookmark might be temporarily deleted until a compelling need to create another
branch head comes up. In these cases the ``yt`` branch will only have one head.
