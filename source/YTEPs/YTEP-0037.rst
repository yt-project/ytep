...
`flake8-bugbear <https://github.com/PyCQA/flake8-bugbear>`_ is a ``flake8`` pluggin that
goes beyond code style and detects some additional anti-patterns, most of which are
